...
class M_pembelian extends CI_Model { 
	...
	var $column_order = array(null,'pembelian_nomor','pembelian_status','kontak_nama','pembelian_faktur'); 

	//kolom yang di tampilkan setelah seacrh
	var $column_search = array('pembelian_nomor','pembelian_status','kontak_nama','pembelian_faktur'); 
